...
import click
import logging
from image_segmentation.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch("image_segmentation.app.utils.logging.click.style",
    ...
    @mock.patch("image_segmentation.app.utils.logging.logging.Formatter")
